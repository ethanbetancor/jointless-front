...
export class ExerciseComponent {
    ...
    send() {
        ...
        this.http.post<exerciseResponse>('http://jointless-back-production.up.railway.app/api/v1/solutions/submit', body,{headers}).subscribe({
            next: (response) => {
    ...
    clue() {
        ...
        this.http.post<clueResponse>('http://jointless-back-production.up.railway.app/api/v1/ai/clue', body,{headers}).subscribe({
            next: (response) => {
